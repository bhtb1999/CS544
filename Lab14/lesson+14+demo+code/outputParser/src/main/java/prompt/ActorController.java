...
public class ActorController {
    ...
    public String getActorFilmsString() {
        return chatClient.prompt()
                .user("Generate a list of the title of all movies Brad Pitt played in between 2013 and 2015")
                .call()
                .content();
    }
    ...
    public ActorFilms getActorFilms() {
        return chatClient.prompt()
                .user("Generate a filmography for Brad Pitt between 2013 and 2015.")
                .call()
    ...
    public List<ActorFilms> listActorFilms() {
        return chatClient.prompt()
                .user("Generate a filmography for the actors Denzel Washington, Leonardo DiCaprio and Brad Pitt between 2013 and 2015")
                .call()
