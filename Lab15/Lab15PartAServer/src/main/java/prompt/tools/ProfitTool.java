...
public class ProfitTool {
    ...
    @Tool(name = "get_profits_by_month", description = "Get the profits from specific month. Use month names like 'January', 'March', 'June'")
    public List<Profit> getProfits(ProfitRequest request) {
